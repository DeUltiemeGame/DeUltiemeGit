package com.cursor.framework.implementation;
...
import com.cursor.framework.Audio;
import com.cursor.framework.FileIO;
...
public abstract class AndroidGame extends Activity implements Game {
	...
	public void setOnline() {
		Boolean online = getSharedPreferences("SharedPrefs", MODE_PRIVATE)
				.getBoolean("online", false);
		Naam.setOnline(online);
	}
}